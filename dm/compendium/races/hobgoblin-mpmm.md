...
![](races/MPMM/Hobgoblin.webp#right)
...
You can use this trait to take the [Help](/3-Mechanics/CLI/actions.md#Help) action as a bonus action, and you can do so a number of times equal to your proficiency bonus. You regain all expended uses when you finish a long rest.

Starting at 3rd level, choose one of the options below each time you take the [Help](/3-Mechanics/CLI/actions.md#Help) action with this trait:
