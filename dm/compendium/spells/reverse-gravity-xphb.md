...
This spell reverses gravity in a 50-foot-radius, 100-foot high [Cylinder](/3-Mechanics/CLI/variant-rules/cylinder-area-of-effect-xphb.md) centered on a point within range. All creatures and objects in that area that aren't anchored to the ground fall upward and reach the top of the [Cylinder](/3-Mechanics/CLI/variant-rules/cylinder-area-of-effect-xphb.md). A creature can make a Dexterity saving throw to grab a fixed object it can reach, thus avoiding the fall upward.
