...
Lightning springs from you to a creature that you try to touch. Make a melee spell attack against the target. On a hit, the target takes `dice:1d8|noform|noparens|avg` (`d8`) Lightning damage, and it can't make [Opportunity Attacks](/3-Mechanics/CLI/actions.md#Opportunity%20Attack) until the start of its next turn.
