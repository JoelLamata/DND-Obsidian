...
You make an area within range magically secure. The area is a [Cube](/3-Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md) that can be as small as 5 feet to as large as 100 feet on each side. The spell lasts for the duration.
