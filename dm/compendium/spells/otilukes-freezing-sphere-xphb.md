...
A frigid globe streaks from you to a point of your choice within range, where it explodes in a 60-foot-radius [Sphere](/3-Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md). Each creature in that area makes a Constitution saving throw, taking `dice:10d6|noform|noparens|avg` (`10d6`) Cold damage on failed save or half as much damage on a successful one.
...
**Using a Higher-Level Spell Slot.** The damage increases by `dice:1d6|noform|noparens|avg|text(d6)` for each spell slot level above 6.
