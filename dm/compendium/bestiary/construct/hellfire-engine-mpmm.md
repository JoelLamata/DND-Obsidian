...
"actions":
  - "desc": "The hellfire engine moves up to its speed in a straight line. During\
      ...
      \ hellfire engine's path. On a failed save, the creature falls [prone](/3-Mechanics/CLI/conditions.md#Prone)\
      \ and takes 28 (8d6) bludgeoning damage.\n\nIf the hellfire engine remains in\
      \ the [prone](/3-Mechanics/CLI/conditions.md#Prone) creature's space, the creature\
      \ is also [restrained](/3-Mechanics/CLI/conditions.md#Restrained) until it's\
      \ no longer in the same space as the hellfire engine. While [restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
