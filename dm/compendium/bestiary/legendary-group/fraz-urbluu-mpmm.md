...
- **Simulacrum.** Fraz-Urb'luu chooses one Humanoid within the lair and instantly creates a simulacrum of that creature (as if created with the [simulacrum](/3-Mechanics/CLI/spells/simulacrum-xphb.md) spell). This simulacrum obeys Fraz-Urb'luu's commands and is destroyed on the next initiative count 20.  
...
- **Beguiling Realm.** Within 6 miles of the lair, all Charisma ([Persuasion](/3-Mechanics/CLI/skills.md#Persuasion)) and Wisdom ([Insight](/3-Mechanics/CLI/skills.md#Insight)) checks have disadvantage, and all Charisma ([Deception](/3-Mechanics/CLI/skills.md#Deception)) and Charisma ([Performance](/3-Mechanics/CLI/skills.md#Performance)) checks have advantage.  
