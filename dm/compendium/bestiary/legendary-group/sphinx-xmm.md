...
- **Infusion of Knowledge.** Whenever the sphinx or one of its allies takes a [Study](/3-Mechanics/CLI/actions.md#Study) action while within 1 mile of the lair, it adds `dice:1d6|noform|noparens|avg` (`d6`) to any ability check it makes for that action.  
