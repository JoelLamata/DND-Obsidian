...
With this option, a creature uses the special [shove](/3-Mechanics/CLI/variant-rules/unarmed-strike-xphb.md) attack from the "Player's Handbook" to force a target to the side, rather than away. The attacker has disadvantage on its Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics)) check when it does so. If that check is successful, the attacker moves the target 5 feet to a different space within its reach.
