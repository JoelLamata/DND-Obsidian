...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](/3-Mechanics/CLI/spells/enlarge-reduce-xphb.md) spell for `dice:1d4|noform|noparens|avg` (`d4`) hours (no [Concentration](/3-Mechanics/CLI/conditions.md#Concentration) required).
